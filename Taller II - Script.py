...
# %%: carga de los datos
ds2015 = pd.read_csv('datasets\\encuesta_felicidad_2015.csv')
ds2016 = pd.read_csv('datasets\\encuesta_felicidad_2016.csv')
ds2017 = pd.read_csv('datasets\\encuesta_felicidad_2017.csv')
